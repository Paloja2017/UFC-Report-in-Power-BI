...
The navigation in the report is mainly two-level, but on some pages I have expanded it to three levels wherwe I saw it reasonable, as can be seen when interacting with the report.
